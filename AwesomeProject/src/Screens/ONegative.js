...
import {Text,TouchableOpacity,View,Button,FlatList,ScrollView} from 'react-native'
...
import { Card } from 'react-native-paper';
  ...
  return(
    ...
    <View style={{textAlign:'center',marginLeft:30,flexDirection:'row',color:"black"}}>
