...
function User_Profile(props,{children}){
    ...
    return(
        ...
        <View style={styles.container}>
          ...
          /> */}
            ...
            <TouchableOpacity style={{flexDirection:"row"}} onPress={choose}>

                <Icon name="image" size={50} color="teal"/>
                <Text style={{fontSize:25,top:10,color:"black"}}> Profile Image</Text>
            </TouchableOpacity>
            <Image source={{uri:Images}}
              style={{width:120,height:110,borderRadius:80,marginLeft:19}}/>
...
<FormButton
buttonTitle="SignUp"
onPress={()=> {send(),props.navigation.navigate("Home")}} />
}
